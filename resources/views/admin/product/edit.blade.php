				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							...
							{{ Form::model($product, array('route' => ['admin.product.update', $product->id], 'role' => 'form', 'class' => 'form-horizontal', 'files' => true, 'method' => 'PUT')) }}
							{{ csrf_field() }}
								...
								<div class="tab-content">
									<div class="tab-pane fade in active" id="general">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												{{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Add Product Name here...']) }}
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="row">
													<div class="col-md-9">
														{{ Form::select('category_id', $categoryList, null, ['class' => 'form-control', 'id' => 'categorylist', 'placeholder' => 'Pick a Category...']) }}
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="row">
													<div class="col-md-9">
													{{ Form::select('brand_id', $brandList, null, ['class' => 'form-control', 'id' => 'brandlist', 'disabled' => true]) }}
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												{{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' =>  'Add Product Description here...', 'rows' => '5', 'cols' => '25']) }}
											</div>
										</div>
									</div>
									...
									<div class="tab-pane fade" id="data">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												{{ Form::text('model', null, ['class' => 'form-control', 'placeholder' => 'Add Product Model here...', 'tab-index']) }}
											</div>
										</div>
													...
													<div class="col-md-8">
														<div class="col-md-12">
															<div class="form-group input-group">
																...
																{{ Form::text('stock', null, array('class' => 'form-control', 'placeholder' => 'Add Product Stock here...', 'tab-index')) }}
															</div>
														</div>
													</div>
												</div>
													...
													<div class="col-md-8">
														<div class="col-md-12">
															<div class="form-group input-group">
																...
																{{ Form::text('price', $product->price, ['class' => 'form-control', 'placeholder' => 'Add Product Price here...', 'tab-index']) }}
										...
										<div class="form-group">
											{{ Form::label('image', 'Product Logo', ['class' => 'col-md-2 control-label']) }}
